...
export const data = {
  arepas: [
    ...
    { shortName: "Sin sal", name: "Sin sal", price: 700, catalog: true, extras: [ 2001, 2002, 3001 ] },
    { shortName: "Sin sal Q", name: "Sin sal Queso", price: 3100 },
    { shortName: "Sin Sal L", name: "Sin Sal Loncha", price: 2700 },
    { shortName: "Loncha", name: "Queso Loncha", price: 2000 },
    { shortName: "Guiso", name: "Guiso", price: 1000 },
  ],
  paquetes: [
    ...
    { shortName: "Sin sal", name: "Paquete Sin sal", price: 7000, catalog: true },
  ],
  bebidas: [
  ...
  huevos: [
    ...
    { shortName: "Pericos", name: "Pericos", price: 5500, catalog: true, extras: [ 4001 ] },
